<%@ page language="java" contentType="text/html; charset=UTF-8"
	import="java.util.List,com.oracle.web.bean.Fenlei" pageEncoding="UTF-8"%>
...
var selectAll=document.getElementById("selectAll");
			...
			deleteStudent.onclick=function(){
				...
				if(queren==true){
					...
					location.href="<%=base %>
	Fenleiservlet?action=deleteFenlei&ids="
						+ str;
			} else {
...
<body background="<%=base%>/imgs/3.jpg">
	...
	<div class="container">
		<table class="table" align="center" width="200px" height="100px"
			border="1px" cellspacing="0" bordercolor="silver">
			<caption align="top">
				<h1 align="center">
		...
		<p class="text-center">第${pb.pageNow }页/共 ${pb.pages }页
			&nbsp;&nbsp;
		<ul class="pager text-center">
			...
			<c:forEach begin="${begin }" end="${end }" var="i">
				<c:choose>
					...
					<c:otherwise>
						<li><a
							href="<%=base %>Fenleiservlet?action=showFenleiByPage&pageNow=${i }">${i }</a>
						<li>
					</c:otherwise>
				</c:choose>
			</c:forEach>
			...
			<c:if test="${pb.pageNow<pb.pages }">
				<li><a
					href="<%=base %>Fenleiservlet?action=showFenleiByPage&pageNow=${pb.pageNow+1 }">
						下一页</a></li>
			</c:if>
			&nbsp;&nbsp;
		...
		<table align="center">
			<tr align="center">
				...
				<td><h3>没有您想要的分类？您可以点击这里</h3>
					<button class="btn btn-sm" id="addfeilei">
						<span class="ui-icon ui-icon-circle-plus"></span> <a
							href="addFenlei.jsp">添加分类</a></td>
			</tr>
		</table>
		</form>
</body>
